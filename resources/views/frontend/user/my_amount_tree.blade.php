...
@section('content')
    <div class="content">
        <div class="tree-con">
            <p class="tree-stress">亲爱的贼主子，您可以领取<span id="all_amount">{{$user->trees}}株</span>果树，请根据您自己的需求选择量：</p>
            ...
            <div class="tree-pack">
                <div class="pack-num">
                    ...
                    <span style="padding-left: 0.3rem">株</span>
                </div>
        ...
        <div class="screen">
            <div class="hint-box">
                ...
                <p class="bottom-hint">果树在7-15个工作日内就可以收到啦</p>
            </div>
            <div class="hint-boxs">
        ...
        <div class="prompt-box">
            <p class="hint-message">超过您可以领取的果树数量！</p>
        </div>
    </div>
    ...
    <script>
        ...
        $('.ch-ad').on('click', function() {
            $(this).addClass('active').parents('li').siblings().children('.ch-ad').removeClass('active');
        });
