            ...
            <div class="col-lg-12">
                <div class="block">
                    <div class="block-header">
                        <h3 class="block-title">商品新增</h3>
                    </div>
                    <div class="block-content block-content-narrow">
                        <form class="js-validation-bootstrap form-horizontal" action="{{route('admin.product.store')}}" method="post" >
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="price">价格 <span class="text-danger">*</span></label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" id="content" name="content" rows="7" style="height: 250px"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
